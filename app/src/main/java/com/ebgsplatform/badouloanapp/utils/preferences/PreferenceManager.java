package com.ebgsplatform.badouloanapp.utils.preferences;
 ...
 *
 * Created by XuanQinjian on 2014/8/21.
 * */
public class PreferenceManager {
    ...
    public static PreferenceOperator getDefault() {
        return getDefault(BDApplication.getAppContext());
    }
    ...
    public static PreferenceOperator getPrivate(String name) {
        return getPreferencesByMode(BDApplication.getAppContext(), name, Context.MODE_PRIVATE);
    }
    ...
    public static PreferenceOperator getAppend(String name) {
        return getPreferencesByMode(BDApplication.getAppContext(), name, Context.MODE_APPEND);
    }
